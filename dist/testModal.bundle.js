...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalQBoxWin = __webpack_require__(159);

	var _ModalQBoxWin2 = _interopRequireDefault(_ModalQBoxWin);
	...
	var TestForm = (function (_React$Component) {
		...
		function TestForm() {
			...
			_get(Object.getPrototypeOf(TestForm.prototype), 'constructor', this).call(this);
			this.state = {
				BoxID: '1'
			};
		}
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'h2',
						null,
						'Show modal window and get return value'
					),
					_react2['default'].createElement(
						'form',
						...
						_react2['default'].createElement(_ModalQBoxWin2['default'], { ref: function (ref) {
								return _this.edQBox = ref;
	...
	(0, _reactDom.render)(_react2['default'].createElement(TestForm, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactModalWithKeysAction = __webpack_require__(160);

	var _reactModalWithKeysAction2 = _interopRequireDefault(_reactModalWithKeysAction);

	__webpack_require__(164);

	var QBoxWin = (function (_React$Component) {
	  _inherits(QBoxWin, _React$Component);

	  function QBoxWin(props) {
	    _classCallCheck(this, QBoxWin);

	    _get(Object.getPrototypeOf(QBoxWin.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(QBoxWin, [{
	    ...
	    key: 'openModalAction',
	    value: function openModalAction() {
	      this.setState({
	        isModalVisible: true
	      });
	    }
	  }, {
	    key: 'closeModalAction',
	    value: function closeModalAction() {
	      this.setState({
	        isModalVisible: false
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', { className: 'form-control', ref: function (ref) {
	            return _this.edBoxID = ref;
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'button',
	            { type: 'Button', className: 'btn btn-small', onClick: this.openModalAction },
	            '...'
	          )
	        ),
	        isModalVisible && _react2['default'].createElement(
	          _reactModalWithKeysAction2['default'],
	          { closeModalAction: this.closeModalAction, modalKeysActions: modalKeysActions, handleKeyDownEvent: true },
	          _react2['default'].createElement(
	            'div',
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                datalist.map((function (item) {
	                  ...
	                  return _react2['default'].createElement(
	                    'tr',
	                    { className: selclass, key: item.code },
	                    _react2['default'].createElement(
	                      'td',
	                      { onClick: this.setValue.bind(this, item.code), style: { cursor: "pointer" } },
	                      item.nm
	                    )
	                  );
	                }).bind(this))
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'button',
	              { type: 'button', className: 'btn btn-primary', onClick: this.SaveAndClose.bind(this) },
	              'OK'
	            ),
	            _react2['default'].createElement(
	              'button',
	              { type: 'button', className: 'btn btn-default', onClick: this.Cancel.bind(this) },
	              'Cancel'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPureRenderComponent = __webpack_require__(161);
	...
	var Modal = (function (_Component) {
	  ...
	  _createClass(Modal, null, [{
	    key: 'propTypes',
	    value: {
	      closeModalAction: _react.PropTypes.func.isRequired,
	      modalKeysActions: _react.PropTypes.array,
	      handleKeyDownEvent: _react.PropTypes.bool
	    },
	    enumerable: true
	  }]);
	  ...
	  Modal.prototype.closeModal = function closeModal(e) {
	  ...
	  Modal.prototype.handleKeyDown = function handleKeyDown(e) {
	    var modalKeysActions = this.props.modalKeysActions;

	    modalKeysActions.forEach(function (item, index) {
	      if (item.key === e.keyCode) {
	        if (item.multiKeys) {
	          (function () {
	            var altPressed = e.getModifierState('Alt');
	            var controlPressed = e.getModifierState('Control');
	            var shiftPressed = e.getModifierState('Shift');
	  ...
	  Modal.prototype.render = function render() {
	    return _react2['default'].createElement(
	      'div',
	      { className: 'react-modal-with-keys-action-background', onClick: this.closeModal },
	      _react2['default'].createElement(
	        'div',
	        { className: 'react-modal-with-keys-action-wrapper' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'react-modal-with-keys-action' },
	          _react2['default'].createElement(
	            'div',
	            { className: 'react-modal-with-keys-action-close' },
	            _react2['default'].createElement('div', { className: 'react-modal-with-keys-action-x' }),
	            _react2['default'].createElement('div', { className: 'react-modal-with-keys-action-x' })
	          ),
	          this.props.children
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _function = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/stylus-loader/index.js!./modal.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./../../node_modules/stylus-loader/index.js!./modal.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".react-modal-with-keys-action-background {\n  background: rgba(0,0,0,0.7);\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  z-index: 99999;\n  top: 0;\n  left: 0;\n  overflow: scroll;\n  display: flex;\n  justify-content: center;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper {\n  position: relative;\n  display: table-cell;\n  vertical-align: middle;\n  width: 100%;\n  padding: 100px 0;\n  overflow-y: auto;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action {\n  position: relative;\n  width: 90%;\n  padding: 25px 25px;\n  background: #fff;\n  margin: 0 auto;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action img {\n  max-width: 100%;\n  max-height: 300px;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action .react-modal-with-keys-action-close {\n  position: absolute;\n  cursor: pointer;\n  right: 50px;\n  top: -30px;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action .react-modal-with-keys-action-close div.react-modal-with-keys-action-x {\n  position: absolute;\n  width: 60px;\n  height: 0;\n  border-top: 3px solid #fff;\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action .react-modal-with-keys-action-close div.react-modal-with-keys-action-x:first-child {\n  transform: rotate(135deg);\n}\n.react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action .react-modal-with-keys-action-close div.react-modal-with-keys-action-x:last-child {\n  transform: rotate(45deg);\n}\n@media only screen and (min-width: 48em) {\n  .react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action {\n    width: 50%;\n    padding: 25px 50px;\n  }\n  .react-modal-with-keys-action-background .react-modal-with-keys-action-wrapper .react-modal-with-keys-action .react-modal-with-keys-action-close {\n    right: 0;\n    top: -30px;\n  }\n}\n", ""]);
